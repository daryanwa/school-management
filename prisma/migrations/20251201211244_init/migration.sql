...
-- AddForeignKey
ALTER TABLE "Class" ADD CONSTRAINT "Class_supervisoId_fkey" FOREIGN KEY ("supervisoId") REFERENCES "Teacher"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
