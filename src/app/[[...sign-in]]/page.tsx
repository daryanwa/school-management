...
const LoginPage = () => {
  ...
  return (
    <div className="h-screen flex items-center justify-center bg-lama-sky">
      <SignIn.Root>
        <SignIn.Step name="start" className="bg-white p-12 rounded-md shadow-2xl flex flex-col gap-2">
          ...
          <SignIn.Action submit className="bg-blue-500 text-sm my-1 rounded-md p-[10px] text-white">Sign In</SignIn.Action>
        </SignIn.Step>
      </SignIn.Root>
    </div>
  )
