...
const Navbar = async () => {
  try {
    ...
    if (process.env.NODE_ENV === "development") {
      ...
      console.log("Navbar - PublicMetadata:", user?.publicMetadata);
    }
      ...
      <div className="flex items-center justify-between p-4">
        ...
        <div className="hidden md:flex items-center gap-2 text-xs rounded-full ring-[1.5px] ring-gray-300 px-2">
          ...
          <input
            type="text"
            placeholder="Search..."
            className="w-[200px] p-2 bg-transparent outline-none"></input>
        </div>
    ...
    return (
      <div className="flex items-center justify-between p-4">
        <div className="text-red-500 text-xs">Error loading navbar</div>
        <UserButton />
      </div>
    );
  }
