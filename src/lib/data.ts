...
// calendarEvents.ts (обновлено под текущую дату: 16 ноября 2025)
export const calendarEvents = [
  ...
  },
  {
    title: "Chemistry",
    allDay: false,
    start: new Date(2025, 10, 19, 13, 0),
    end: new Date(2025, 10, 19, 13, 45),
  },
  {
    title: "History",
    allDay: false,
